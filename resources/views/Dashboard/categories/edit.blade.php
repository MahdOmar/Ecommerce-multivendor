            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" placeholder=" write some text ..." name="summary">{{$category->summary}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="check" type='checkbox' name="is_parent" value="{{$category->is_parent}}" {{$category->is_parent == 1 ? 'checked': ''}}  > Yes                         
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 {{$category->is_parent == 1 ? 'd-none': ''}}" id="parent_cat">      
