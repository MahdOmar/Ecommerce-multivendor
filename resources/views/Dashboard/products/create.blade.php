                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" id="summary" placeholder=" write some text ..." name="summary">{{old('summary')}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" id="description" placeholder=" write some text ..." name="description">{{old('description')}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" max="100" step="any" class="form-control" name='discount' placeholder="discount" value="{{old("discount")}}">
                                    </div>
                                </div>
                ...
                success:function(response)
                {
                    ...
                    if(response.status)
                    {
                        ...
                        $.each(response.data,function(title,id){
                            ...
                            html_options += '<option value ="'+id+'">'+ title+'</option>' 
