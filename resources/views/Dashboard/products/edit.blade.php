                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" id="summary" placeholder=" write some text ..." name="summary">{{$product->summary}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" id="description" placeholder=" write some text ..." name="description">{{$product->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" max="100" step="any" class="form-control" name='discount' placeholder="discount" value="{{$product->discount}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">     
                                    ...
                                    <select id="sel_cat" name="cat_id" class="form-control show-tick">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 d-none" id="child_cat">     
                                    <label for="">Child Category: </label>                           
                                    <select id="sel_child" name="child_cat_id" class="form-control show-tick">
...
<script>
    ...
    var child_cat = {{$product->child_cat_id}}


    $('#sel_cat').change(function(){
        console.log('lfdlffllflf');
        ...
        if(cat_id != null)
        {
            $.ajax({
                ...
                {
                    var html_options = '<option value="">-- Child Category -- </option>' 
                    if(response.status)
                    {
                        $('#child_cat').removeClass('d-none');
                        $.each(response.data,function(title,id){
                            console.log(id+"***"+title)
                            html_options += '<option value ="'+id+'"'+(child_cat == id ? 'selected' : "")+'>'+ title+'</option>' 
