                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled team-info margin-0">                                                
                                            <li><img src="{{asset('dashboard/assets/images/xs/avatar3.jpg')}}" title="Avatar" alt="Avatar"></li>
                                            <li><img src="{{asset('dashboard/assets/images/xs/avatar2.jpg')}}" title="Avatar" alt="Avatar"></li>
                                        </ul>
                                    </td>
                                    <td>$ 542</td>
                                </tr>
