                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" placeholder=" write some text ..." name="description">{{old('description')}}</textarea>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">     
                                ...
                                <select name="condition" class="form-control show-tick">
                                    ...
                                    <option value="banner" {{old('condition') == 'banner' ? 'selected' : ''}}>Bnner</option>
