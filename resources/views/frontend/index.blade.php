            ...
            <div class="col-12 col-md-4">
                <div class="single_catagory_area mt-50">
                    <a href="{{route('product.category',$category->slug)}}">
                        <img width="350" height="350" src="{{$category->photo}}" alt="">
                    </a>
                </div>
            </div>
                ...
                <div class="new_arrivals_slides owl-carousel">
                    ...
                    <div class="single-product-area">
                        ...
                        <div class="product_description">
                            ...
                            <h6 class="product-price">{{number_format( $product->offer_price,2)}} <small><del>{{number_format( $product->price,2)}}</del></small> </h6>
                        </div>
                    </div>
