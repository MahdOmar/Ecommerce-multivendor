            ...
            <div class="row h-100 align-items-center">
                <div class="col-6">
                    <div class="welcome-note">
                        ...
                        <span class="text">Welcome to Timimoun-Market ecommerce website.</span>
                    </div>
                </div>
                <div class="col-6">
        ...
        <div class="container">
            <div class="classy-nav-container breakpoint-off">
                <nav class="classy-navbar" id="bigshopNav">
                    ...
                    <!-- Nav Brand -->
                    <a href="{{route('main')}}" class="nav-brand"><img src="{{asset('frontend/img/core-img/logo.png')}}" alt="logo"></a>
